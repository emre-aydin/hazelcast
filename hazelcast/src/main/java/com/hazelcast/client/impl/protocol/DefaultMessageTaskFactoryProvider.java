...
import com.hazelcast.client.impl.protocol.task.management.GetDataStructuresMessageTask;
...
public class DefaultMessageTaskFactoryProvider implements MessageTaskFactoryProvider {
    ...
    private void initializeManagementCenterTaskFactories() {
        ...
        factories.put(MCGetDataStructuresCodec.REQUEST_MESSAGE_TYPE,
                (cm, con) -> new GetDataStructuresMessageTask(cm, node, con));
    }
