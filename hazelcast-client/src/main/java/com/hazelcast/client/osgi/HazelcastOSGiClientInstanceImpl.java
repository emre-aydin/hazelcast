 ...
 */
class HazelcastOSGiClientInstanceImpl
        implements HazelcastOSGiClientInstance {

    private final HazelcastInstance delegatedInstance;
    private final HazelcastClientOSGiService ownerService;

    public HazelcastOSGiClientInstanceImpl(HazelcastInstance delegatedInstance,
                                           HazelcastClientOSGiService ownerService) {
    ...
    @Override
    public HazelcastClientOSGiService getOwnerService() {
        return ownerService;
    }
    ...
    public boolean equals(Object o) {
        ...
        HazelcastOSGiClientInstanceImpl that = (HazelcastOSGiClientInstanceImpl) o;
